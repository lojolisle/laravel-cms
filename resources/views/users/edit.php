    ...
    <section class="w3-padding">
        ...
        <form method="post" action="/console/users/edit/<?= $user->id ?>" novalidate class="w3-margin-bottom">
            ...
            <div class="w3-margin-bottom">
                ...
                <input class="w3-input" type="text" name="first" id="first" value="<?= old('first', $user->first) ?>" required>
            ...
            <div class="w3-margin-bottom">
                ...
                <input class="w3-input" type="text" name="last" id="last" value="<?= old('last', $user->last) ?>" required>
            ...
            <div class="w3-margin-bottom">
                ...
                <input class="w3-input" type="email" name="email" id="email" value="<?= old('email', $user->email) ?>">
